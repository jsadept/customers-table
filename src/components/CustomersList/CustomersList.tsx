...
import CustomersListEmptyState from "./CustomersListEmptyState";
    ...
    useEffect(
        () => {
            if (debouncedSearchTerm) {
                dispatch(sortListByQuery(debouncedSearchTerm))
            }
            else{
                dispatch(sortListByQuery(''))
            }
        },
        [debouncedSearchTerm]
    );
        ...
        <>
            {
                ...
                ?
                <CustomersListEmptyState {...{setIsModalOpen}}/>
                :
                <div className="px-0 rounded-xl bg-white">
            ...
            <Modal {...{isModalOpen, setIsModalOpen}}>
                <AddCustomerForm setIsModalOpen={setIsModalOpen} />
            </Modal>
        </>
    )
};
